...
//      멤버십 결제 메인 페이지
      ...
      if (pathURL.equals("/PaymentSelect.py")) {
...
//      멤버십 결제 등록 뷰 확인
      else if (pathURL.equals("/PaymentInsertView.py")) {
...
//      결제 내역 전체 조회
      else if (pathURL.equals("/PaymentHistory.py")) {
...
//      로그인 확인
         ...
         paymentHandlerAdapter.setPath("/WEB-INF/view/access/member_login.jsp");
         log.info("로그인 뷰 확인 - " + paymentHandlerAdapter);
         
      }

//    멤버십 첫 페이지
      else if (pathURL.equals("/PaymentMain.py")) {
          paymentHandlerAdapter = new PaymentHandlerAdapter();

          paymentHandlerAdapter.setPath("/WEB-INF/view/payment/payment_main.jsp");
          log.info("멤버십 메인 페이지 이동 확인 - " + paymentHandlerAdapter);
