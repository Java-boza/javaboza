       ...
       <table class="table table-hover">
        ...
        <tbody>
         <tr class="text-center">
           ...
           <div class="row">
        <div class="col-md-4">
			<a href="./PaymentUpdateView.py?user_id=${paymentDTO.user_id}" class="btn btn-warning btn-block">
    멤버십 수정하기</a>
        </div>
        <div class="col-md-4">
			<a href="./PaymentDeleteView.py?user_id=${paymentDTO.user_id}" class="btn btn-danger btn-block">
    멤버십 해지하기</a>
        </div>
        <div class="col-md-4">
        	<a href="./PaymentHistory.py?user_id=${paymentDTO.user_id}" class="btn btn-primary btn-block">결제 내역 보기</a>
        </div>
       </div>
      </div>
     </div>
