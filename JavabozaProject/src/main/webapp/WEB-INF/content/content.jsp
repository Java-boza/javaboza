...
h1 {
    color: #fff; /* JAVABOZA 글씨의 색상을 흰색으로 변경 */
    margin-bottom: 0; /* h1 요소의 하단 마진을 0으로 설정하여 간격을 조절 */
}
h2 {
   font-size: large;
...
<%-- 세션이 없는 경우에 해당하는 CSS 클래스 --%>
<% if (userId == null || userId.isEmpty()) { %>
  #comment_write, .edit_btn, .delete_btn {
    display: none;
  }
<% } %>
</style>
            ...
            success : function() {
               ...
               $.ajax({
                  ...
                  success : function(data) {
                     ...
                     var userName = '<%= session.getAttribute("user_id") %>';
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-comment">
							<a class="nav-link active" href="./CommentStart.co">댓글</a>
						</li>
						<li class="nav-playlist">
